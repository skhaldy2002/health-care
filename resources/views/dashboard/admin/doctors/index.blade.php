                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable">
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px" style="padding-right: 15px">Verified</th>
    ...
    <script>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var handleDeleteRows = () => {
                ...
                const verifyButtons = document.querySelectorAll('#verify_row');
                const cancelDeleteButtons = document.querySelectorAll('#cancel_delete_row');
                const cancelVerifyButtons = document.querySelectorAll('#cancel_verify_row');
                            ...
                            if (result.value) {
                                ...
                                Swal.fire({
                                    ...
                                    Swal.fire({
                                        ...
                                        var url = '{{route("admin.doctors.delete",[":id"])}}';
                ...
                verifyButtons.forEach(d => {
                    ...
                    d.addEventListener('click', function (e) {
                        ...
                        // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                        Swal.fire({
                            text: "{{__('Are you sure you want to verify')}} " + customerName + "?",
                            icon: "warning",
                            showCancelButton: true,
                            buttonsStyling: false,
                            confirmButtonText: "Yes!",
                            ...
                            if (result.value) {
                                ...
                                Swal.fire({
                                    ...
                                    Swal.fire({
                                        ...
                                        // delete row data from server and re-draw datatable
                                        var url = '{{route("admin.doctors.verified-by-admin",[":id"])}}';
                                        url = url.replace(':id', record_id);
                    ...
                    d.addEventListener('click', function (e) {
                        ...
                        Swal.fire({
                            ...
                            customClass: {
                                ...
                                cancelButton: "btn fw-bold btn-active-light-active"
                            }
                        }).then(function (result) {
                            if (result.value) {
                                // Simulate delete request -- for demo purpose only
                                Swal.fire({
                                    text: " canceled deleted " + customerName,
                                    icon: "info",
                                    buttonsStyling: false,
                                    showConfirmButton: false,
                                    timer: 2000
                ...
                cancelVerifyButtons.forEach(d => {
                    ...
                    d.addEventListener('click', function (e) {
                        ...
                        // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                        Swal.fire({
                            text: "Are you sure you want to cancel verify " + customerName + "?",
                            icon: "warning",
                            showCancelButton: true,
                            buttonsStyling: false,
                            confirmButtonText: "Yes!",
                            ...
                            if (result.value) {
                                // Simulate delete request -- for demo purpose only
                                Swal.fire({
                                    text: " canceled verified " + customerName,
                                    icon: "info",
                                    buttonsStyling: false,
                                    showConfirmButton: false,
                                    timer: 2000
