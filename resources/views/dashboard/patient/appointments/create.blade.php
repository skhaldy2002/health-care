                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active"
                        ...
                        <form id="kt_docs_formvalidation_text" class="form p-4" method="post"
                              action="{{getActionForm('patient.appointments.store',@$item)}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 mb-10">
                                    <!--begin::Label-->
                                    <label class=" fw-semibold  mb-2">Doctors</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select class="form-select form-select-solid   fw-bolder "
                                            data-kt-select2="true" data-placeholder="Doctors" name="doctor_id"
                                            data-allow-clear="true" id="doctor_filter">
                                        <option></option>
                                        @foreach($doctors as $doctor)
                                            <option value="{{$doctor->id}}" {{isset($item)?($item->doctor_id == $doctor->id?'selected':''):''}}>{{$doctor->name}}</option>
                                        @endforeach
