                ...
                <div class="d-flex flex-column flex-lg-row-fluid py-10">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid">
                        ...
                        <form id="kt_docs_formvalidation_text" class="form p-4" method="post"
                              action="{{route('doctor_signup.store')}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-10">
                                    <!--begin::Label-->
                                    <label class=" fw-semibold  mb-2">Specialties</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select class="form-select form-select-solid   fw-bolder "
                                            data-kt-select2="true" data-placeholder="specialties" name="specialty_id"
                                            data-allow-clear="true" id="specialty_id">
                                        <option></option>
