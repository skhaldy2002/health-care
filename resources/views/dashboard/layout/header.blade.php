...
{{--                                                        <!--begin::Title-->--}}
{{--                                                        <div class="mb-0 me-2">--}}
{{--                                                            <a href="{{route('notifications.readAt',['id'=>$notification['id']])}}"--}}
{{--                                                               class="fs-6 text-gray-800 text-hover-{{$notification['read_at']?'success':'danger'}} fw-bolder">{{$notification['title']}}</a>--}}
{{--                                                            --}}{{--                                                                <div class="text-gray-400 fs-7">Phase 1 development</div>--}}
{{--                                                        </div>--}}
{{--                                                        <!--begin::Title-->--}}
{{--                                                        <div class="mb-0 me-2" style="word-break: break-word;">--}}
{{--                                                            <a href="{{route('notifications.readAt',['id'=>$notification['id']])}}"--}}
{{--                                                               class="fs-6 text-gray-800 text-hover-{{$notification['read_at']?'success':'danger'}} fw-bolder">{{$notification['body']}}</a>--}}
{{--                                                            --}}{{--                                                                <div class="text-gray-400 fs-7">Phase 1 development</div>--}}
{{--                                                        </div>--}}
{{--                                                        <!--end::Title-->--}}
{{--                                                    </div>--}}
